...
const modelsFolders = ["./models", "../human-models/models", "../blazepose/model/", "../anti-spoofing/model", "../efficientpose/models", "../insightface/models", "../movenet/models", "../nanodet/models"]
...
async function main() {
  ...
  await build.run("production-no-docs")
